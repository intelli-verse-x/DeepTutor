...
def _classify_error(user_answer: str) -> ErrorType | None:
    """Basic classification. Full AI-based classification in error_diagnosis stage."""
    # Blank = didn't know (metacognitive); otherwise default to a wrong application.
...
async def submit_answer(book_id: str, body: AnswerRequest):
    ...
    error_type = None
    if not is_correct:
        error_type = _classify_error(body.user_answer)
